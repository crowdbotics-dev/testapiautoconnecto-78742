...
## Project Structure
    ...
    ├── testapiautoconnecto_78742  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_78742`
...
2. Clone this repo and `cd testapiautoconnecto_78742`
